  ...
  <q-page class="q-gutter-lg fit row wrap justify-between items-start content-start" id="page">
    ...
    <q-list id="stat-block">
      ...
      <div id="introduction">
        ...
        <div>
          <div id="name" class="text-capitalize" v-text="character.introduction.name"></div>
        ...
        <div>
          <span id="race" class="text-capitalize" v-text="character.introduction.heritage"/>
      ...
      <q-expansion-item v-if="character.statistics" id="statistics"
        ...
        <div id="ability scores">
          <span v-for="(score, key, index) in character.abilityScores.value"
                v-bind:key="index">
            <b class="text-capitalize"> {{ key.substr(0, 3) }}</b> {{ score }}
            ({{
              formatBonus(
        ...
        <div>
          ...
          <span v-if="featToggle" id="feats" class="text-capitalize"
